...
class TasksParents extends StatefulWidget {
  const TasksParents({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _TasksParents createState() => _TasksParents();
}

class _TasksParents extends State<TasksParents> {
              ...
              TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ViewPage(documentSnapshot: documentSnapshot)),
                    );
                  }),
